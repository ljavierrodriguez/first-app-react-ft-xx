...
## Crear proyecto react usando create-next-app (nextjs)
...
## Crear proyecto react usando vite (react) 

Crear proyecto y seguir los pasos:
```shell
$ npm create vite 
```

Crear proyecto con nombre y seguir los pasos
```shell
$ npm create vite appname
```

Crear proyecto en la carpeta actual y seguir los pasos:
```shell
$ npm create vite .
```
O pasar directamente el tipo de proyecto a utilizar:
```shell
